		...
		<div class="col-lg-8" style="margin: 0 auto;">
            <div class="card">
              	<div class="card-body">
                	...
                	<hr>
                	<form:form action="product/update.htm" modelAttribute="product">
               			<div class="form-group">
                    		<label for="input-1">Mã mặt hàng</label>
                    		<form:input path="maMH" class="form-control form-control-rounded" id="input-1" readonly="true" />
                    		<form:errors path="maMH" class="invalid-feedback" />
                  		</div>
                  		<div class="form-group">
                    		<label for="input-2">Tên mặt hàng</label>
                    		<form:input path="tenMH" class="form-control form-control-rounded" id="input-2" required="true" />
                  		...
                  		<div class="form-group">
                    		...
                    		<form:select path="maLoai" items="${type }" itemValue="maLoai" itemLabel="tenLoai" selected="true" class="form-select">
                    		</form:select>
							<form:errors path="maLoai" class="text-danger" />
                  		</div>
                  		<div class="form-group">
                    		<label for="input-7">Mô tả ngắn</label>
                    		<form:input path="moTaNgan" class="form-control form-control-rounded" id="input-7" />
                    		<form:errors path="moTaNgan" class="text-danger" />
                  		</div>
                  		<div class="form-group">
                    		<label for="input-8">Mô tả</label>
                    		<form:input path="moTa" class="form-control form-control-rounded" id="input-8" />
