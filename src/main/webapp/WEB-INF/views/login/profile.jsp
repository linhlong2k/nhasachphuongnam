        ...
        <div class="col-lg-4">
           <div class="card profile-card-2">
            <div class="card-img-block">
                <img class="img-fluid" src="template/admin/assets/images/gallery/31.jpg" alt="Card image cap">
            </div>
            <div class="card-body pt-5">
                <img src="template/admin/assets/images/avatars/avatar-15.png" alt="profile-image" class="profile">
            ...
            <div class="card-body border-top border-light">
                 <div class="media align-items-center">
                   <div>
                       <img src="template/admin/assets/images/timeline/html5.svg" class="skill-img" alt="skill img">
                   </div>
                  ...
                  <hr>
                  <div class="media align-items-center">
                   <div><img src="template/admin/assets/images/timeline/bootstrap-4.svg" class="skill-img" alt="skill img"></div>
                     <div class="media-body text-left ml-3">
                       <div class="progress-wrapper">
                   ...
                   <hr>
                  <div class="media align-items-center">
                   <div><img src="template/admin/assets/images/timeline/angular-icon.svg" class="skill-img" alt="skill img"></div>
                     <div class="media-body text-left ml-3">
                       <div class="progress-wrapper">
                    ...
                    <hr>
                  <div class="media align-items-center">
                   <div><img src="template/admin/assets/images/timeline/react.svg" class="skill-img" alt="skill img"></div>
                     <div class="media-body text-left ml-3">
                       <div class="progress-wrapper">
