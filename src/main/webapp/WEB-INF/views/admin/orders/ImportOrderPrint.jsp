					...
					<div class="invoice-header">
						<div class="invoice-from">
							...
							<address class="m-t-5 m-b-5">
								<strong class="text-inverse">${nhaCungCap.tenNhaCungCap }</strong><br>
								Địa chỉ: ${nhaCungCap.diaChi } <br> Số điện thoại:
								${nhaCungCap.soDienThoai } <br> Email:
							</address>
						</div>
						...
						<div class="invoice-date">
							...
							<div class="invoice-detail">
								...
								<b>Mã nhân viên phụ trách:</b>${donHang.maNhanVien }
							</div>
						</div>
					</div>
					<!-- end invoice-header -->
					...
					<div class="invoice-content">
							...
							<table class="table table-invoice table-striped">
								<thead>
									<tr>
										...
										<th class="text-right" width="20%">Thành giá</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach var="item" items="${donHang.chiTiets }">
										<tr>
											...
											<td class="text-right"><fmt:formatNumber pattern="#,###.## VND; -#,###.## VND" value="${item.gia }" type="currency" /></td>
											<td class="text-right"><fmt:formatNumber pattern=" #,###.## VND; -#,###.## VND" value="${item.gia * (1 - item.giamGia) * item.soLuong}" /></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
						...
						<div class="invoice-price">
							...
							<div class="invoice-price-right">
								<small>Tổng tiền</small> <span class="f-w-600"><fmt:formatNumber pattern="#,###.## VND; -#,###.## VND" value="${tongTien }" type="currency"/></span>
							</div>
						</div>
						<!-- end invoice-price -->
					</div>
