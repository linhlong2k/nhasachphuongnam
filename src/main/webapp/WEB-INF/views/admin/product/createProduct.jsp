		...
		<div class="col-lg-8" style="margin: 0 auto;">
            <div class="card">
              	<div class="card-body">
                	...
                	<hr>
                	<form:form action="mat-hang/tao-mat-hang-moi.htm" modelAttribute="matHangMoi">
               			<div class="form-group">
                    		<label for="input-1">Mã mặt hàng</label>
                    		<form:input path="maMatHang" type="text" class="form-control form-control-rounded" id="input-1" readonly="true" />
                  		...
                  		<div class="form-group">
                    		...
                    		<form:select path="maLoai" items="${danhSachLoaiMatHang }" itemValue="maLoai" itemLabel="tenLoai" class="form-control form-control-rounded"/>
