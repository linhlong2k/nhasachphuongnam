		...
		<div class="col-lg-8" style="margin: 0 auto;">
            <div class="card">
              	<div class="card-body">
                	...
                	<hr>
                	<form:form action="mat-hang/chinh-sua-mat-hang.htm" modelAttribute="matHangChinhSua">
               			<div class="form-group">
                    		<label for="input-1">Mã mặt hàng</label>
                    		<form:input path="maMatHang" class="form-control form-control-rounded" id="input-1" readonly="true" />
                    		<form:errors path="maMatHang" class="invalid-feedback" />
                  		</div>
                  		<div class="form-group">
                    		<label for="input-2">Tên mặt hàng</label>
                    		<form:input path="tenMatHang" class="form-control form-control-rounded" id="input-2" required="true" />
                  		...
                  		<div class="form-group">
                    		...
                    		<form:input path="gia" class="form-control form-control-rounded" id="input-4" />
                    		<form:errors path="gia" class="text-danger" />
                  		</div>
                  		<div class="form-group">
                    		<label for="input-5">Số lượng</label>
                    		<form:input path="soLuong" class="form-control form-control-rounded" id="input-5" />
                  		...
                  		<div class="form-group">
                    		...
                    		<form:select path="maLoai" items="${type }" itemValue="maLoai" itemLabel="tenLoai" selected="true" class="form-control form-control-rounded">
                    		</form:select>
							<form:errors path="maLoai" class="text-danger" />
                  		</div>
                  		<div class="form-group">
                    		<label for="input-7">Mô tả ngắn</label>
                    		<form:textarea path="moTaNgan" class="form-control form-control-rounded" id="input-7" />
                    		<form:errors path="moTaNgan" class="text-danger" />
                  		</div>
                  		<div class="form-group">
                    		<label for="input-8">Mô tả</label>
                    		<form:textarea path="moTa" class="form-control form-control-rounded" id="input-8" />
