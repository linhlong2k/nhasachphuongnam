		...
		<div class="col-lg-8" style="margin: 0 auto;">
            <div class="card">
              	<div class="card-body">
                	...
                	<hr>
                	<form:form action="mat-hang/chinh-sua-mat-hang.htm" method="post" modelAttribute="matHangChinhSua">
                  		...
                  		<div class="form-group">
                    		...
                    		<form:input path="gia" type="number" class="form-control form-control-rounded" id="input-4" />
                    		<form:errors path="gia" class="text-danger" />
                  		</div>
                  		<div class="form-group">
                    		<label for="input-5">Số lượng</label>
                    		<form:input path="soLuong" type="number" class="form-control form-control-rounded" id="input-5" />
                  		...
                  		<div class="form-group">
                    		...
                    		<form:select path="maLoai" items="${danhSachLoaiMatHang }" itemValue="maLoai" itemLabel="tenLoai" selected="true" class="form-control form-control-rounded">
                    		</form:select>
