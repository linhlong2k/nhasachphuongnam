			...
			<div class="col-md-7 col-lg-9">
				<div class="panel panel-info" style="background-color: #fff; margin-top: 20px;">
					<div class="block-header block-header-default" style="background-color: #ced4da; padding: 0; margin: 0px;">
						<h3 class="block-title font-w600" style="background-color: #ced4da; margin: 0px; padding: 10px;"> DANH SÁCH ĐƠN HÀNG</h3>
					</div>
							...
							<div class="card">
					            ...
					            <div class="table-responsive">
					                <table class="table align-items-center" id="table-hoa-don">
					                	<thead>
					                		<tr>
					                            <th rowspan="2" style="margin: 0; padding: 10px 10px;"><i class="text-white mr-2"></i>Mã đơn</th>
					                            <th rowspan="2" style="margin: 0; padding: 10px 10px;">Thời gian</th>
					                            <th rowspan="2" style="margin: 0; padding: 10px 10px;">Giảm giá</th>
					                            <th rowspan="2" style="margin: 0; padding: 10px 10px;">Tình trạng</th>
					                            <!-- <th rowspan="2" style="margin: 0; padding: 10px 10px;">Địa chỉ nhận hàng</th> -->
					                            <th colspan="3" style="margin: 0; padding: 10px 10px;">Chi tiết đơn hàng</th>
					                        </tr>
					                        <tr>
					                        	<th>Mã đơn hàng</th>
					                        	<th>Số lượng</th>
					                    ...
					                    <tbody>
					                        ...
					                        <tr>
						                    	...
						                    	<td style="margin: 0; padding: 10px;"><fmt:formatNumber pattern="#,###.# %; -#,###.# %" value="${eo.giamGia }" type="currency" /></td>
						                    	...
						                    	<table>
						                    		<c:forEach var="item" items="${eo.chiTiets }">
							                    		<tr>
							                    			<td style="margin: 0; padding: 10px;">${item.maMatHang }</td>
							                    			<td style="margin: 0; padding: 10px;">${item.soLuong }</td>
							                    			<td style="margin: 0; padding: 10px;"><fmt:formatNumber pattern="#,###.## VND; -#,###.## VND" value="${item.gia }" type="currency" /></td>
							                    		</tr>
						                    		</c:forEach>
						                    	</table>
						                    	</td>
